...
def outputTest():
    ...
    task = n.createTask()
    task.CreateAOVoltageChan("/Dev1/ao0", "", -10.0, 10.0, n.Val_Volts, None)
    task.CfgSampClkTiming(None, 10000.0, n.Val_Rising, n.Val_FiniteSamps, 1000)
...
def syncADTest():
    print("::::::::::::::::::  A/D  Test  :::::::::::::::::::::")
    task1 = n.createTask()
    task1.CreateAIVoltageChan("/Dev1/ai0", "", n.Val_RSE, -10.0, 10.0, n.Val_Volts, None)
...
def syncIOTest():
    ...
    data1[60:80] = 5.0
    print("Wrote ao samples:", task2.write(data1))
    print("Wrote do samples:", task4.write(data1.astype(np.uint32)))
    task2.start()
    task3.start()
    task1.start()
    data2 = task1.read()
